...
void loop(){
  ...
  if(valor1){
    Serial.println("macaco-comendo");
 
  }
  if(valor2){
   Serial.println("macaco-comendo-banana"); 
 
  } 
  if(valor3){
    Serial.println("macaco-comendo-cavalo");  
  
  }
  if(valor4){
    Serial.println("cavalo-comendo-macaco");
  
  }
    if(valor5){
    Serial.println("tirulipa");
